        ...
        <div className="container hanz-page">
            ...
            <HanzHeaderContainer title="Research Overview">
                <p className="fw-normal hanz-research-lead">
                    I design and reason about communication and coordination in emerging computing systems. Specifically, research vision is to develop scalable, secure, and intelligent architectures for emerging classical and quantum systems, with a focus on the interconnects and system-level orchestration of modular, heterogeneous designs in order to improve the performance, reliability, and trustworthiness of next-generation computing infrastructure. More broadly, my interests lie at the intersection of computer architecture, quantum computing, computer networks, systems security, and machine learning for systems. During my doctoral studies and postdoctoral research, I have had the opportunity to work on challenging research problems alongside talented collaborators.
                </p>
            </HanzHeaderContainer>
