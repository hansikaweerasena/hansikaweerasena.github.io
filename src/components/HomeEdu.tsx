            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="row hanz-edu-row">
                        ...
                        <div className="col">
                            <h1 className="fs-5 hanz-edu-title">Doctor of Philosophy, Computer Science </h1>
                            <h1 className="fs-6 hanz-edu-subtitle">University of Florida </h1>
                    ...
                    <div className="row hanz-edu-row">
                        ...
                        <div className="col">
                            <h1 className="fs-5 hanz-edu-title">Bachelor of the Science of Engineering (Hons)</h1>
                            <h1 className="fs-6 hanz-edu-subtitle">University of Moratuwa, Sri Lanka</h1>
