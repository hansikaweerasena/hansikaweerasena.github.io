...
export function HomeService() {
    return (<HanzHeaderContainer title="Professional Services" buttonText="" buttonPath="">
            ...
            <ul>
                ...
                <li>IEEE International Symposium on Hardware Oriented Security and Trust (<em>HOST</em>), 2023 and 2024</li>
                <li>ACM/IEEE International Conference on Hardware/Software Codesign and System Synthesis (<em>CODES+ISSS</em>), 2022, 2023</li>
