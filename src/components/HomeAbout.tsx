...
export function HomeAbout() {
    return (<HanzHeaderContainer title="About Me" buttonText="" buttonPath="/about">
            <div id="hanz-home-about-p">
                <p className="fw-normal"> I am a postdoctoral researcher in the Department of Computer Science at North Carolina State University, where I work with Prof. Jianqing Liu. My current research focuses on system-level methods for modular and heterogeneous quantum computing architectures, interconnects, and scheduling. I received my Ph.D. in Computer Science from the University of Florida in August 2025, advised by Prof. Prabhat Mishra, where my research focused on secure on-chip interconnects, trusted execution environments, and machine learning for systems security. </p>
                <p className="fw-normal"> My research vision is to develop scalable, secure, and intelligent architectures for emerging classical and quantum systems, with a focus on the interconnects and system-level orchestration of modular, heterogeneous designs. Specifically, my research agenda centers on two connected directions: developing systems-level methods for modular and heterogeneous quantum computing architectures, and designing scalable, and secure interconnects for emerging computing systems. </p>
                <p className="fw-normal"> My work has resulted in one book chapter, 12 peer-reviewed publications in venues including ACM TODAES, IEEE TCAD, ACM TECS, IEEE/ACM DATE, IEEE HOST, and IEEE QCE, and three pending patents. I have also served on multiple technical program committees, reviewed for several journals and conferences, and served as a lead researcher on research projects funded by SRC and NSF. My long-term goal is to build an independent and collaborative research program focused on scalable, secure, and intelligent future computing infrastructure. </p>
                <p className="fw-normal"> Outside research, I enjoy running, hiking, trekking, photography, exploring national parks and wilderness, playing and watching soccer, and exploring about topics beyond my expertise that spans my curiosity. </p>
            </div>
        </HanzHeaderContainer>
    );
}
