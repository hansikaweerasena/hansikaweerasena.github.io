    ...
    return (
        <HanzContainer>
                ...
                <div className="col text-center">
                    ...
                    <ul className="list-inline">
                        <li className="list-inline-item me-4">
                            <a href="https://scholar.google.com/citations?user=ZN96WzcAAAAJ&hl=en" target="_blank">
                    ...
                    <li className="list-inline-item me-4">
                        <a href="https://www.linkedin.com/in/hansikamweerasena/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                             width="20" height="20"
                             viewBox="0 0 16 16"
                             fill="currentColor">
                    ...
                    <li className="list-inline-item">
                        <a href="https://stackoverflow.com/users/7161203/hansika-weerasena" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                             width="20" height="20"
                             viewBox="0 0 16 16"
                             fill="currentColor"
            ...
            <div className="col-lg-4 text-center">
                ...
                <p id="hanz-home-about-p" className="fw-normal text-center">Hansika is a PhD Candidate at the Department
                    of
                ...
                <button className="btn btn-link btn-sm fw-light shadow-sm" type="button" data-bs-target="#">Read More
                    About Hansika
                </button>
            </div>
