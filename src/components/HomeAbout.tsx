...
export function HomeAbout() {
    return (<HanzHeaderContainer title="About Me" buttonText="Read More" buttonPath="/about">
            <div id="hanz-home-about-p">
                <p className="fw-normal"> I am a postdoctoral researcher in the Department of Computer Science at North Carolina State University, where I work with Professor Jianqing Liu. My current research focuses on system-level methods for modular and heterogeneous quantum computing architectures, interconnects, and scheduling. I received my Ph.D. in Computer Science from the University of Florida in August 2025, advised by Professor Prabhat Mishra, where my research focused on secure and efficient on-chip interconnects, trusted execution environments, and applied machine learning for secure computing architectures. </p>
                <p className="fw-normal"> More broadly, my interests lie at the intersection of computer architecture, quantum computing, computer networks, security, and applied machine learning for systems. My research vision is to develop scalable, efficient, and secure computing architectures, interconnects, and system-level orchestration for emerging classical and quantum systems. Specifically, my research agenda centers on two connected directions: developing systems-level methods for modular and heterogeneous quantum computing architectures, and designing efficient, reliable, and secure interconnects for emerging computing systems. </p>
                <p className="fw-normal"> My work has resulted in one book chapter, 12 peer-reviewed publications in venues and journals including IEEE HOST, IEEE/ACM DATE, IEEE TCAD, ACM TECS, and ACM TODAES, and three pending patents. I have also served on multiple technical program committees, reviewed for several journals and conferences, and served as a lead researcher on research projects funded by SRC and NSF. My long-term goal is to build an independent and collaborative research program focused on scalable, secure, and intelligent future computing infrastructure. </p>
                <p className="fw-normal"> Outside research, I enjoy running, hiking, trekking, photography, exploring national parks and wilderness areas, playing and watching soccer, and learning about topics beyond my immediate expertise. </p>
            </div>
        </HanzHeaderContainer>
    );
}
