                                ...
                                <div className="card-body">
                                    ...
                                    <div className="read-article mt-4">
                                        <a className="d-flex justify-content-between align-items-center text-decoration-none fw-bold"
                                           ...
                                           style={{ color: theme === 'light' ? 'rgb(33, 37, 41)' : 'white', letterSpacing: '0.2em' }}
                                        >
                                            <span>R E A D&nbsp;&nbsp;&nbsp;&nbsp;A R T I C L E</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-arrow-right ms-3" viewBox="0 0 16 16">
                                                <path fillRule="evenodd" d="M10.293 1.5a.5.5 0 0 1 .707 0l4.5 4.5a.5.5 0 0 1 0 .707l-4.5 4.5a.5.5 0 0 1-.707-.707L13.793 6H1.5a.5.5 0 0 1 0-1h12.293l-3.5-3.5a.5.5 0 0 1 0-.707z"/>
                                            </svg>
                                        </a>
                                    </div>
